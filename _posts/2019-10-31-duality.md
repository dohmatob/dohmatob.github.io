...
II.1 Banach spaces, linear operators, convexity			
======================
#### II.1.1 -- Banach spaces, their duals, and bounded linear operators
...
at the point $x \in \X$ is the normal cone $N_C(x)$ at $x$ defined by*
