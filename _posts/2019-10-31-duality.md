...
Given a Banach space $$\X=(\X,\|.\|)$$ over the reals $\mathbb K=\mathbb R$ or complex numbers $\mathbb K=\mathbb C$,
...
The second part of the Lemma is not that easy to proof...
...
$$
\chi_C(\xstar) = \sup_{x \in C}\;\langle \xstar,x\rangle \ge \sup_{x \in R^+(x_0)}\;\langle \xstar,x\rangle = \lambda \langle \xstar,x_0\rangle \overset{\lambda \rightarrow +\infty}{\longrightarrow} +\infty, \text{ because } \langle \xstar,x_0\rangle > 0.
$$
