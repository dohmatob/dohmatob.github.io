...
$$
d=\sup_{\xstar \in \Xstar,\; \xstar \ge 0,\;\Astar\xstar = c}\langle b,\xstar\rangle. \tag{Dual-LP}
$$
...
The FRDT prescribes sufficient conditions under which there is strong duality.
