...
II.4 Exercises
=================
**Exercise 2.4.1.** What is the Fenchel conjugate of the function $g:\mathbb R^n \rightarrow (-\infty, +\infty]$ defined by $g(x) := \max (x_1,\ldots,x_p)$ ?
...
**Exercise 2.4.5.** Let $a \in \mathbb R^n$ and $\sigma_1,\ldots,\sigma_p > 0$, and consider the function $g:\mathbb R^n \rightarrow (-\infty, +\infty]$ defined by
$$
g(x)=
\begin{cases}
