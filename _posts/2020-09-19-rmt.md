...
preceeding theorem to guarantee the existance of $c_k>0$ depending only
...
>**Lemma (covering-number bound).** For every $\epsilon \in (0, 1)$, we have the bound $\card(\enet(S)) \le (3/\epsilon)^k$. More generally, if
