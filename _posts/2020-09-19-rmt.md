...
$C>0$. Indeed, a version of this theorem with a perculiar value of $C$
...
large entropy costs associated with union bounds over event such as
the one in the theorem. This trick will be playerd in the proof of
...
### I.3 -- Prerequisites
Though not strictly necessary, basic vocabulary concerning the stuff
